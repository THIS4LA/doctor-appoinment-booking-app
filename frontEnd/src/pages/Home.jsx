              ...
              <div>
                <div className="lg:w-[570px]">
                  ...
                  <p className="text__para">
                    ...
                    Est inventore, excepturi necessitatibus omnis, pariatur,
                    delectus dolorem ipsa deserunt alias ab officia molestias
                    magnam eligendi repellat doloribus voluptatum dolor ipsum.
                    Nesciunt.
                  </p>
            ...
            <div className='flex items-center justify-between flex-col lg:flex-row'>
              ...
              <div className='xl:w-[670px]'>
                ...
                <ul className='pl-4'>
                  ...
                  <li className='text__para'>
                    2.View our physicians who are accepting new patients,
