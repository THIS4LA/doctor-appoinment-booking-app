        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className="lg:w-[570px]">
                <h1 className="text-[36px] leading-[46px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]">
                  We help patients live a healthy, longner Life
                </h1>
                <p className="text__para">
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit. Est
                  inventore, excepturi necessitatibus omnis, pariatur, delectus
                  dolorem ipsa deserunt alias ab officia molestias magnam
                  eligendi repellat doloribus voluptatum dolor ipsum. Nesciunt.
                </p>
            ...
            <div className="flex gap-[30px] justify-end">
              <div>
                <img className="w-full" src={heroImg01} alt="toppic" />
              </div>
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className="w-5 h-5 lg:w-[34px] lg:h-[34px] flex items-center justify-center bg-yellowColor rounded
